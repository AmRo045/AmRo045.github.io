...
export default function DatabaseIcon(props: SVGProps<SVGSVGElement>) {
    return (
		...
		C24.727,14.339,20.127,15.954,14.627,15.954z"
            />
            <path
                d="M14.627,23.31c-5.494,0-10.098-1.616-11.355-3.788c-0.221,0.381-0.35,0.779-0.35,1.191v3.564
		...
		C24.727,21.694,20.127,23.31,14.627,23.31z"
            />
            <path
                d="M26.018,5.042c-0.23,2.016-5.232,3.629-11.391,3.629c-6.156,0-11.158-1.613-11.387-3.628
		...
		C26.338,5.791,26.219,5.409,26.018,5.042z"
            />
            <path
                d="M14.627,7.541c6.303,0,11.41-1.687,11.41-3.771c0-2.082-5.107-3.77-11.41-3.77
